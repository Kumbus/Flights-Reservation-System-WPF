...
{
    /// <summary>
    /// Klasa odpowiadająca lini lotniczej Lufthansa
    /// </summary>
    public class Lufthansa : BasicFlight
    {
        ...
        {
            return "Cudowny lot z Lufthansa";
        }
        ...
        public override List<BasicFlight> GenerateDerived()
        {
            ...
            derived.Add(new Lufthansa_Economy(this));
            derived.Add(new Lufthansa_EconomyPremium(this));
            derived.Add(new Lufthansa_Business(this));
            derived.Add(new Lufthansa_First(this));
